...
def main(odb_path, parts=None, nodesets=None, nodes=None):
        ...
        for step_key, step_val in odb.steps.values():
            ...
            for frame in odb.steps[step_val.name].frames:
                ...
                for nodeset in nodesets:
                    curr_nodes = odb.rootAssembly.instances[part].nodeSets[nodeset]
    ...
    return pd.DataFrame.from_dict(final_record)
